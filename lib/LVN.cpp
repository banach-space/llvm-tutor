...
//         Function: commonsubexprexlimination
//
//
...
struct LVN : PassInfoMixin<LVN> {
    ...
    for (auto BB = F->begin(), eBB = F->end(); BB != eBB; BB++) {
      ...
      for (auto inst = BB->begin(), eInst = BB->end(); inst != eInst;) {
        ...
        if (auto op = dyn_cast<BinaryOperator>(inst)) {
          ...
          if (l && r) {
            long result = 0;
            switch (op->getOpcode()) { // if both are constants then they can be
                                       // folded
  ...
  void commonsubexprexlimination(Function *F) {
    errs() << "................................................................"
              "..................\n";
