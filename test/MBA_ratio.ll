; RUN:   opt -load ../lib/liblt-mba-shared%shlibext -mba -mba-ratio=1 -S %s | FileCheck -check-prefix=MBA %s
; RUN:   opt -load ../lib/liblt-mba-shared%shlibext -mba -mba-ratio=0 -S %s | FileCheck -check-prefix=NO_MBA %s
